...
class _ScorePageState extends State<ScorePage> {
  ...
  Widget build(BuildContext context) {
    ScoreBloc scoreBloc = BlocProvider.of<ScoreBloc>(context);
          ...
          if (state is ScoreLoaded) {
            ...
            for (int i = 0; i < levels.length; i++) {
              if (user.allbalance! >= levels.last.mustCoins!) {
                ...
                proverkaNext = levels.last.name;
                break;
              } else if (user.allbalance! >= levels[i].mustCoins! &&
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 10.w,
                                            vertical:
                                                Platform.isIOS ? 22.h : 25.h),
                                        child: SizedBox(
                                          height:
                                              Platform.isIOS ? 700.h : 700.h,
                                          child: Column(
                                            mainAxisAlignment:
                                      ...
                                      ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            return itemScore(
                                                ...
                                                user.rus!
                                                    ? levels[index].name ?? ''
                                                    : levels[index].engName ??
                                                        '',
                                                user.rus!
                                                    ? levels[index].desc ?? ''
                                                    : levels[index].descEng ??
                                                        '');
                                          }),
          ...
          SizedBox(
            ...
            child: ClipRRect(
              ...
              child: LinearProgressIndicator(
                value: value,
                backgroundColor: LightAppColors.greySecondary,
            ...
            child: SizedBox(
              ...
              child: Text(
                ...
                style: score >= mustCoins || title == proverkaNext
                    ...
                    : CustomTextStyle.sf12w400(LightAppColors.greySecondary),
              ),
            ),
          ),
          SizedBox(height: 2.h),
  ...
  Color? colorBoxDecoration(int score, int mustCoin, String title) {
    if (score >= mustCoin && proverka == title) {
      return LightAppColors.purplePrimary;
    } else {
      return LightAppColors.greySecondary;
    }
  }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                title,
                style: CustomTextStyle.sf17w400(LightAppColors.purplePrimary)
