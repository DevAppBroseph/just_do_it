...
class WelcomePage extends StatefulWidget {
  ...
  const WelcomePage(this.onSelect, {super.key});
                              ...
                              : SizedBox(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Padding(
                                          padding: EdgeInsets.only(left: 3.6.w),
                                                              ...
                                                              child: SizedBox
                                                                  .fromSize(
                                                                      ...
                                                                      child: user?.photoLink ==
                                                                          ...
                                                                          : CachedNetworkImage(
                                                                              imageUrl: user!.photoLink!.contains(server) ? user!.photoLink! : server + user!.photoLink!,
                                                                              fit: BoxFit.cover,
                                                                            )),
                                                            ),
                                                          ),
