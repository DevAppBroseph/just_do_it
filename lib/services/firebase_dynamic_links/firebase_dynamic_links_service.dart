...
class FirebaseDynamicLinksService {
  ...
  void share(String? refCode) async {
    log(refCode.toString());
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      androidParameters: const AndroidParameters(packageName: 'dev.broseph.justDoIt'),
      iosParameters: const IOSParameters(bundleId: 'dev.broseph.justDoIt', minimumVersion: '13.0', appStoreId: '1669574224', ),
    );
